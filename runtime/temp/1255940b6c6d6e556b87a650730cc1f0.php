<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"E:\phpStudy\WWW\yqyblog\public/../application/admin\view\Config\add_config.html";i:1530510520;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
  ...
  <div class="body-content">
    <form class="form-x" onsubmit="return false">
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="config_name" id="config_name" />
        </div>
      </div>
      <div class="form-group">
        <div class="label">
      ...
      <div id="alipay" style="display: block">
        <div class="form-group">
          ...
          <div class="field">
            <input type="text" class="input w50" value="" name="appid" id="zfb_appid" />
          </div>
        </div>
        <div class="form-group">
          <div class="label">
          ...
          <div class="field">
            <input type="text" class="input w50" value="" name="appsecret" id="zfb_appsecret" />
          </div>
        </div>
        <div class="clear"></div>
        <div class="form-group">
          ...
          <div class="field">
            <input type="text" class="input w50" name="mchid" value="" id="zfb_mchid"/>
          </div>
        </div>
        <div class="form-group">
          <div class="label">
          ...
          <div class="field">
            <input type="text" class="input w50" name="mchkey" value="" id="zfb_mchkey" />
          </div>
        </div>
      </div>
      ...
      <div id="weixin" style="display: none">
        <div class="form-group">
          ...
          <div class="field">
            <input type="text" class="input w50" value="" name="appid" id="wx_appid"/>
          </div>
        </div>
        <div class="form-group">
          <div class="label">
          ...
          <div class="field">
            <input type="text" class="input w50" value="" name="appsecret" id="wx_appsecret"/>
          </div>
        </div>
        <div class="clear"></div>
        <div class="form-group">
          ...
          <div class="field">
            <input type="text" class="input w50" name="mchid" value="" id="wx_mchid"/>
          </div>
        </div>
        <div class="form-group">
          <div class="label">
          ...
          <div class="field">
            <input type="text" class="input w50" name="mchkey" value="" id="wx_mchkey"/>
          </div>
        </div>
      </div>
      ...
      <div id="sms" style="display: none">
        <div class="form-group">
          ...
          <div class="field">
            <input type="text" class="input w50" value="" name="appid" id="sms_appid"/>
          </div>
        </div>
        <div class="form-group">
          <div class="label">
          ...
          <div class="field">
            <input type="text" class="input w50" value="" name="appsecret" id="sms_appsecret"/>
          </div>
        </div>
        <div class="form-group">
          <div class="label">
          ...
          <div class="field">
            <input type="text" class="input w50" value="" name="smsid" id="sms_smsid"/>
          </div>
        </div>
        <div class="form-group">
          <div class="label">
          ...
          <div class="field">
            <input type="text" class="input w50" value="" name="sign" id="sms_sign"/>
          </div>
        </div>
      </div>
