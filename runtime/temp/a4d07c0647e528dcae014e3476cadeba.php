<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:57:"E:\phpStudy\WWW\yuqingyong\thinkphp\tpl\dispatch_jump.tpl";i:1522829834;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
  <meta charset="utf-8" />
  ...
  <style type="text/css">
 *{ padding: 0; margin: 0; }
 body{ background: #fff; font-family: '微软雅黑'; color: #CCC; font-size: 12px; }
 .system-message{ padding: 24px 48px; margin:auto; border: #CCC 3px solid; top:50%; width:350px; border-radius:10px;
 ...
 .system-message .success,.system-message .error{ line-height: 1.8em;  color: #999; font-size: 20px; font-family: '黑体'; }
