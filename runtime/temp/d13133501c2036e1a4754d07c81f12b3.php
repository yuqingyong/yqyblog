<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:77:"E:\phpStudy\WWW\yuqingyong\public/../application/home\view\Release\index.html";i:1516915804;s:60:"E:\phpStudy\WWW\yuqingyong\application\home\view\layout.html";i:1516915804;s:67:"E:\phpStudy\WWW\yuqingyong\application\home\view\public\header.html";i:1522915697;s:65:"E:\phpStudy\WWW\yuqingyong\application\home\view\public\rili.html";i:1516915804;s:67:"E:\phpStudy\WWW\yuqingyong\application\home\view\public\footer.html";i:1522915777;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<section class="container">
  <div class="content-wrap">
    <div class="content">
      ...
      <article class="excerpt excerpt-1"><a href="<?php echo url('home/Release/fabu'); ?>">暂时没有相关需求！前往发布需求>></a></article>
      <?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$va): $mod = ($i % 2 );++$i;?>
          <article class="excerpt excerpt-1">
          	<a class="focus" href="<?php echo url('home/Release/demand_detail',array('xid'=>$va['xid'])); ?>" title="<?php echo $va['title']; ?>" target="_blank" >
          		<?php if($va['type'] == '项目承接'): ?>
          			<img class="thumb" data-original="__PUBLIC__/home/images/chenjie.jpg" src="__PUBLIC__/home/images/chenjie.jpg" alt="项目承接"  style="display: inline;">
          			<?php elseif($va['type'] == '人才招聘'): ?>
          			<img class="thumb" data-original="__PUBLIC__/home/images/rencai.jpg" src="__PUBLIC__/home/images/rencai.jpg" alt="人才招聘"  style="display: inline;">
          			<?php else: ?>
          			<img class="thumb" data-original="__PUBLIC__/home/images/zhaomu.jpg" src="__PUBLIC__/home/images/zhaomu.jpg" alt="项目招募"  style="display: inline;">
          		<?php endif; ?>
          	</a>
          <header><a class="cat" href="<?php echo url('home/Release/demand_detail',array('xid'=>$va['xid'])); ?>" title="$va['cat_id']" >需求列表<i></i></a>
            <h2><a href="<?php echo url('home/Release/demand_detail',array('xid'=>$va['xid'])); ?>" title="$va['title']" target="_blank" ><?php echo $va['title']; ?></a></h2>
          </header>
          <p class="meta">
          <time class="time"><i class="glyphicon glyphicon-time"></i> <?php echo $va['create_time']; ?></time>
          <span class="views"><i class="glyphicon glyphicon-eye-open"></i> <?php echo $va['see_num']; ?></span> <a class="comment"  title="评论" target="_blank" ><i class="glyphicon glyphicon-comment"></i><?php echo $va['comment_num']; ?></a></p>
          <p class="note"><?php echo $va['content']; ?></p>
        </article>
    ...
    <div class="fixed">
      ...
      <div class="widget widget_sentence">
        ...
        <div class="widget-sentence-content">
            	<li class="demand"><a href="<?php echo url('home/Release/fabu'); ?>">发布需求>></a></li>
        </div>
      </div>
    </div>
    <div class="widget widget_hot">
          ...
          <ul>
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$va): $mod = ($i % 2 );++$i;?>  
                <li><a title="<?php echo $va['title']; ?>" href="<?php echo url('home/Release/rel_detail',array('xid'=>$va['xid'])); ?>" ><span class="thumbnail">
                		<?php if($va['type'] == '项目承接'): ?>
			          			<img class="thumb" data-original="__PUBLIC__/home/images/chenjie.jpg" src="__PUBLIC__/home/images/chenjie.jpg" alt="项目承接"  style="display: block;">
			          			<?php elseif($va['type'] == '人才招聘'): ?>
			          			<img class="thumb" data-original="/tpl/Home/Public/images/rencai.jpg" src="__PUBLIC__/home/images/rencai.jpg" alt="人才招聘"  style="display: block;">
			          			<?php else: ?>
			          			<img class="thumb" data-original="__PUBLIC__/home/images/zhaomu.jpg" src="__PUBLIC__/home/images/zhaomu.jpg" alt="项目招募"  style="display: block;">
			          		<?php endif; ?>
                </span><span class="text"><?php echo $va['title']; ?></span><span class="muted"><i class="glyphicon glyphicon-time"></i>
                    <?php echo $va['create_time']; ?>
                </span><span class="muted"><i class="glyphicon glyphicon-eye-open"></i><?php echo $va['see_num']; ?></span></a></li>
