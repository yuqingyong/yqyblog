<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"E:\phpStudy\WWW\yuqingyong\public/../application/admin\view\Article\add_article.html";i:1516915804;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="<?php echo url('admin/Article/add_article'); ?>" enctype="multipart/form-data">  
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="keywords"/>
        </div>
      </div>
      <div class="clear"></div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="click" value="" />
        </div>
      </div>
      <div class="form-group">
        <div class="label">
        ...
        <div class="field">
          <textarea type="text" class="input w50" name="description" /></textarea>
        </div>
      </div>
      <div class="form-group">
        <div class="label">
