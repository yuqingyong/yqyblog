<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"E:\phpStudy\WWW\yuqingyong\public/../application/home\view\Index\register.html";i:1516915804;s:67:"E:\phpStudy\WWW\yuqingyong\application\home\view\public\footer.html";i:1516915804;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
	<head>
			...
			<div class="regist-process-wrapper">
				<div class="regist-process-body fl wfs">
					...
					<div class="regist-process-register-left fl">
						...
						<form id="registerForm" action="<?php echo url('home/Index/register'); ?>" method="post" name="formUser">
							<div>
							...
							<div>
								...
								<img src="<?php echo captcha_src(); ?>" alt="captcha" class="fl" style="cursor: pointer;margin-top:16px;margin-left:10px;"  onclick="this.src='<?php echo captcha_src(); ?>?seed='+Math.random()">
							</div>
					...
					<div class="regist-process-register-right fr">
						...
						<a class="btn btn-info login-now" href="<?php echo url('home/Index/login'); ?>">立即登录</a>
...
　　 }else{
		$.ajax({
			type:"post",
			url:"<?php echo url('home/Index/check_username'); ?>",
